...
export interface BaseOptions {
  ...
  */
  ...
  /* Announces date/month changes via an aria-live region for screen readers. */
  ...
  */
  ...
  /* Title shown in the calendar title bar. */
  calendarTitle: string;

  /* Whether to render the calendar title bar. */
  showTitleBar: boolean;

  /* Whether to render the close button in the title bar. */
...
Use it along with "enableTime" to create a time picker. */
  ...
  */
  ...
  /* Defines which day should receive first keyboard focus when tabbing into the day grid. */
